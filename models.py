...
class Inventory(models.Model):
    invent_id = models.CharField(max_length=12)
    ...
    apt_id = models.CharField(max_length=2, blank=True, null=True)
...
class Pics(models.Model):
    pics_link = models.BinaryField(blank=True, null=True)
    img = models.CharField(max_length=100)
    invent = models.ForeignKey(Inventory, models.DO_NOTHING, db_column='invent')
