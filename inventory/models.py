...
class Inventory(models.Model):
    invent_id = models.CharField(primary_key=True, max_length=12)
...
class Pics(models.Model):
    invent = models.ForeignKey(Inventory, models.DO_NOTHING, blank=True, null=True)
    pics_link = models.CharField(max_length=255, blank=True, null=True)
